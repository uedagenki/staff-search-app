...
class _SupportChatScreenState extends State<SupportChatScreen> {
  ...
  final List<Map<String, dynamic>> _messages = [
    {
      'text': 'こんにちは！スタッフサーチ運営サポートです。スタッフの皆様をサポートいたします。',
      'isSupport': true,
      'time': '9:00',
    },
  ];
          ...
          if (_messages.length == 1)
            Container(
              ...
              child: Wrap(
                ...
                runSpacing: 8,
                children: [
                  _buildQuickReplyButton('プラン変更'),
                  _buildQuickReplyButton('売上の確認'),
                  _buildQuickReplyButton('配信設定'),
                  _buildQuickReplyButton('その他'),
                ],
              ),
            ),
          // メッセージ入力欄
